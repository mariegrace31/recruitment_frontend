...
function Testimonials() {
  return (
    <div className='bg-[#F5F5FF] p-24' id='testimonials'>
      <h1 className='uppercase font-medium text-center text-[14px]'>testimonials</h1>
      <p className='font-semibold text-center text-3xl mt-3'>Hear what they say about us</p>
      <div className='bg-white mt-16 flex rounded-3xl w-[60%] mx-auto'>
        <div className='p-5'>
          <p className='text-xs leading-7'>"We needed to fill a critical role quickly, and LK Recruitment came through for us. Their team understood our urgent needs and presented
           ...
           <div className='flex gap-6 mt-4 items-center'>
            ...
            <p className='text-[10px] bg-secondary/15 p-1 rounded-xl px-2'>HR Manager at COTTAGE HAVEN</p>
           </div>
        </div>
        <Image src={image} width={300} height={100} alt='testimonial' className='rounded-r-3xl' />
      </div>
    </div>
  )
}
