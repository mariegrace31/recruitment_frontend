  ...
  return (
    <div className='bg-white flex flex-col lg:flex-row p-8 lg:p-28 gap-10 lg:gap-28'>
      <div className='w-[100%] lg:w-[50%] flex flex-col gap-6 lg:gap-12'>
        ...
        <h2 className='text-[20px] lg:text-[38px] font-semibold'>Exciting Job Opportunities Available!</h2>
        <p className='text-[14px] lg:text-[18px]'>We're hiring! If you're passionate, dedicated, and looking for a rewarding career, we have multiple job openings across various fields. Whether you're interested in supporting a kitchen team, providing care as a nanny, maintaining a clean and organized home, or driving with care and precision, we have the perfect role for you. Explore our available positions and take the next step in your career with us. Apply now and become part of a team that values hard work, integrity, and community</p>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 w-[100%] lg:w-[55%]'>
        ...
        <div className='flex flex-col gap-3 border border-secondary p-4 py-8 rounded-lg bg-[#F8FAFF] hover:bg-[#E0E6F7] group'>
          ...
          <p className='text-sm'>JJoin our team as a Kitchen Assistant - where passion for food meets opportunity.</p>
          <Link href="/jobdetail">
          <button className='bg-[#E0E6F7] p-2 rounded-md w-[40%] ml-auto text-[13px] text-secondary group-hover:bg-secondary group-hover:text-white'>More Details</button>
          </Link>
        </div>
