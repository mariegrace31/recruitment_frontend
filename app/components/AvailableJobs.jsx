  ...
  return (
    <div className='bg-white flex p-28 gap-28'>
      <div className='w-[50%] flex flex-col gap-12'>
        ...
        <h2 className='text-[38px] font-semibold'>Ready Jobs To Apply In November</h2>
        <p className='text-[18px]'>Manage an efficient and effective CX operation Manage an efficient and effective CX operation, Manage an efficient and effective CX operation Manage an efficient and
