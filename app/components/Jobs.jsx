...
function Jobs() {
  return (
    <div className='flex flex-col lg:flex-row mx-auto justify-center bg-tertiary p-5 lg:p-14 gap-12 lg:gap-32'>
      ...
      <h1 className='text-[12px] lg:text-lg font-medium'>JOB OPPORTUNITIES</h1>
      <h3 className='font-semibold text-[15px] lg:text-2xl'>Unlock Your Potential with Career Pathways</h3>
        <div className='flex flex-col gap-3 mt-4'>
          <h3 className='font-semibold text-[13px] lg:text-[19px]'>Career Growth Paths</h3>
        ...
        <div className='flex flex-col gap-3 mt-3'>
          <h3 className='font-semibold text-[13px] lg:text-[19px]'>Job Openings</h3>
        ...
        <div className='flex flex-col gap-3 mt-3' >
          <h3 className='font-semibold text-[13px] lg:text-[19px]'>Tailored Career Guidance</h3>
