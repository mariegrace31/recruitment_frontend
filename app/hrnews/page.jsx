  ...
  return (
    <div className='bg-white'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 mt-0 lg:mt-32 p-16 px-3'>
        ...
        <h3 className='px-3 text-[14px] lg:text-[16px]'>How to Prepare for a Job Interview</h3>
        <p className='px-3 text-[12px] lg:text-[14px] font-light leading-6'>Preparing for a job interview can be daunting. Here are some practical tips to help you stand out and make a lasting impression on your potential employer...</p>
        <Link href='/hrdetail'>
       <button className='flex items-center gap-1 px-3 text-[12px] lg:text-[14px]'>Learn more <GoArrowRight className='bg-secondary  rounded-2xl p-1 text-white text-2xl' /></button>
       </Link>
      </div>

       <div className='rounded-xl border border-black/20 flex flex-col gap-4 pb-6'>
       <Image src={blog2} width={401} height={100} alt='hr image' className='rounded-t-xl w-full object-cover' />
       <h3 className='px-3 text-[14px] lg:text-[16px]'>LK Recruitment embraces the agenda 2063 for a thriving future.</h3>
       <p className='px-3 text-[12px] lg:text-[14px] font-light leading-6'>LK Recruitment Rwanda recently participated in the “One Africa, One HR” Summit, held at the Kigali Convention Center in Kigali, Rwanda. </p>
       <Link href='/blog2'>
       <button className='flex items-center gap-1 px-3 text-[12px] lg:text-[14px]'>Learn more <GoArrowRight className='bg-secondary  rounded-2xl p-1 text-white text-2xl' /></button>
       </Link>
       </div>
      ...
      <h3 className='px-3 text-[14px] lg:text-[16px]'>Top 5 Soft Skills Employers Look For</h3>
       <p className='px-3 text-[12px] lg:text-[14px] font-light leading-6'>Preparing for a job interview can be daunting. Here are some practical tips to help you stand out and make a lasting impression on your potential employer...</p>
       <Link href='#'>
       <button className='flex items-center gap-1 px-3 text-[12px] lg:text-[14px]'>Learn more <GoArrowRight className='bg-secondary  rounded-2xl p-1 text-white text-2xl' /></button>
       </Link>
