  ...
  return (
    <div>
      <div className='p-20'>
        ...
        <Image src={blog2} width={990} height={60} alt='recruiter'  className='relative mx-auto bg-gray-300 p-2 rounded-3xl  mt-9'/>
        <Image src={lines} width={100} height={50} alt='lines' className=' mx-auto -mt-24  object-cover'/>
        </div>

        <div className='mt-24 text-center'>
          <h1 className='text-[50px]'>One Africa, One HR: LK Recruitment Rwanda Embraces the Agenda 2063 for a
          Thriving Future</h1>
          <Image src={dot} width={820} height={1} alt='dothr' className='mt-6 mx-auto' />
        </div>

        <div className='flex flex-col gap-9 mt-12 px-20'>
          <p className='text-[20px] leading-9'>LK Recruitment Rwanda recently participated in the “One Africa, One HR” Summit, held at the Kigali Convention Center in Kigali, Rwanda. This landmark event brought together leading HR professionals from across the African continent, emphasizing the shared vision of a prosperous and integrated Africa by 2063, a vision that aligns perfectly with our core values.</p>

          <p className='text-[20px] leading-9'>At LK Recruitment, we go beyond traditional recruitment. We believe in building a brighter future by:</p>

           <ul className='list-disc'>
            <li className='text-[20px] leading-9'> <span className='font-bold text-[22px]'>Empowering Individuals: </span>Providing the right training, competitive salaries, and benefits to help people reach their full potential.</li>
            <li className='text-[20px] mt-2 leading-9'><span className='font-bold'>Driving Positive Change: </span>We help navigate the evolving business landscape, ensuring our clients and their employees thrive in a dynamic environment.</li>
            <li className='text-[20px] mt-2 leading-9'><span className='font-bold'>Integrating Social Responsibility: </span>We embed social and environmental responsibility into everything we do, from our business operations to our decision-making. This commitment to Corporate Social Responsibility (CSR0) is fundamental to our culture, defining our values and shaping who we are as an organization.</li>
            <li className='text-[20px] mt-2 leading-9'><span className='font-bold'>Promoting Diversity, Equity, and Inclusion: </span>We believe in a world where everyone has the opportunity to succeed, and we actively champion diversity, equity, and inclusion within our organization.</li>
           </ul>

           <p className='text-[20px] leading-9'>The summit provided a valuable platform for engaging with other HR professionals and candidates. We were proud to showcase our commitment to the Agenda 2063 at our booth, where we connected with numerous stakeholders, discussing our unique approach to talent sourcing and placement. We actively participated in the dynamic discussions surrounding the future of HR in Africa, particularly its role in achieving the goals of the Agenda 2063. We were inspired by the insightful presentations and panel discussions, which shed light on the objectives for 2063 and the necessary evolution of management practices to achieve them.</p>
           <p className='text-[20px] leading-9'>We are committed to incorporating these valuable insights into our own practices and initiatives.
